      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            {/*  <ul className="sub-menu">*/}
            {/*    <li>*/}
            {/*      <Link to="/dashboard">{props.t("Organs Contour")}</Link>*/}
            {/*    </li>*/}
            {/*    <li>*/}
            {/*      <Link to="/dashboard-saas">{props.t("Tumor Contour")}</Link>*/}
            {/*    </li>*/}
            {/*  </ul>*/}
            {/*</li>*/}
            ...
            <li>
              <Link to="#">
                <i className="bx bx-chat"></i>
                <span>{props.t("Dose Calculator")}</span>
              </Link>
            </li>
            <li>
              <Link to="#">
                <i className="bx bx-file"></i>
                <span>{props.t("Evaluation")}</span>
              </Link>
            </li>
          </ul>
        </div>
